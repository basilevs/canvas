...
- **FILE-005**: `Models/Board.cs` — Board document model with ownership, membership (BoardMember with ForcedName), visibility, embedded `ActiveStrokes` snapshot (`HiddenRanges` added by the visibility moderation plan)
